...
config.model = 'cem'
config.test = True
config.model_path = 'save/test/CEM_19999_42.1962'  # 使用 v5 PPL 最优权重
...
def main():
    ...
    plt.title('t-SNE Visualization of EPCL Emotion Manifold (v5)', fontsize=16)
    ...
    save_path = os.path.join(output_dir, 'Fig_EPCL_tsne_v5.png')
