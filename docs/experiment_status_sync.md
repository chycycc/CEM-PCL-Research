...
| 文件 | 行数 | 角色 | 状态 |
| --- | --- | --- | --- |
| [model_base.py](file:///e:/github/CEM-master/src/models/CEM/model_base.py) | 746 | CEM 原版 Baseline（纯净参照） | ✅ 冻结，无任何 EPCL 代码 |
| [model_epcl.py](file:///e:/github/CEM-master/src/models/CEM/model_epcl.py) | 807 | EPCL 增强版（独立备份） | ✅ 包含 EPCL，与 model.py 同步 |
| [model.py](file:///e:/github/CEM-master/src/models/CEM/model.py) | 807 | **当前激活版本** — EPCL v5 | ⚡ main.py import 此文件 |
| [model_base_bak.py](file:///e:/github/CEM-master/src/models/CEM/model_base_bak.py) | 746 | model_base.py 的冗余备份 | 🔒 与 model_base.py 完全相同 |
...
#### CEM Baseline (`model_base.py:464-520`)
```
...
**关键路径** ([model.py:570-673](file:///e:/github/CEM-master/src/models/CEM/model.py#L570-L673)):
...
**训练循环** ([main.py:75-136](file:///e:/github/CEM-master/main.py#L75-L136)):
